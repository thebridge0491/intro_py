...
.PHONY: prep_swig
prep_swig build/classic_c_wrap.c : intro_py/practice/classic_c.i ## prepare Swig files
	-swig -python -I$(ffi_incdir) -outdir build -o build/classic_c_wrap.c intro_py/practice/classic_c.i
