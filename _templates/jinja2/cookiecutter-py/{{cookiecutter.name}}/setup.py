...
PROJECT = '{{cookiecutter.parent}}.{{cookiecutter.project}}'
...
class Test0(Command):
{% if 'nose2' == cookiecutter.testfrwk %}
...
setup(
    ...
    classifiers=[
        ...
        licenseclassifiers.get('{{cookiecutter.license}}', "License :: OSI Approved :: Apache Software License"),
